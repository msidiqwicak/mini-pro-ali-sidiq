...
async function main() {
    ...
    const event3 = await prisma.event.upsert({
        ...
        create: {
            ...
            description: "Festival musik elektronik terbesar di Asia Tenggara kembali hadir di surga pulau Bali. Bali Beat Festival 2025 menghadirkan DJ dan producer elektronik kelas dunia untuk tiga malam penuh hiburan tanpa henti. Dengan latar belakang pantai Seminyak yang eksotis, ini adalah festival yang wajib kamu hadiri tahun ini.",
    ...
    const event5 = await prisma.event.upsert({
        ...
        create: {
            ...
            description: "Malam konser musik klasik yang elegan dan memukau bersama Surabaya Philharmonic Orchestra. Merasakan keindahan karya-karya agung Mozart, Beethoven, dan Chopin yang dibawakan oleh musisi berkelas internasional di gedung bersejarah Balai Pemuda Surabaya. Dress code: smart casual.",
    ...
    const event6 = await prisma.event.upsert({
        ...
        create: {
            ...
            description: "Nikmati pertunjukan musik gratis di tengah kota Jakarta bersama keluarga dan sahabat. Acara rutin bulanan yang menampilkan musisi berbakat Jakarta di taman kota yang rindang. Bawa tikar, makanan favorit, dan nikmati sore hari yang menyenangkan bersama orang-orang terkasih.",
        ...
        data: [
            {
                ...
                eventId: event2.id,
                rating: 5,
                comment: "Festival jazz terbaik yang pernah saya hadiri! Lineup-nya luar biasa dan suasananya sangat meriah. Pasti akan datang lagi tahun depan!",
            },
            {
                userId: customer2.id,
                eventId: event1.id,
                rating: 4,
                comment: "Konser yang sangat memukau! Sound system kelas dunia dan penampilan artis yang energik. Sayang antrian masuk cukup panjang.",
            },
        ],
    });
    ...
    console.log("\n📋 Login credentials:");
    console.log("   Organizer: organizer@soundwave.com / password123 (Role: ORGANIZER)");
    console.log("   Organizer2: organizer2@beatbox.com / password123 (Role: ORGANIZER)");
    console.log("   Customer: customer@gmail.com / password123 (Role: CUSTOMER)");
    console.log("   Customer2: customer2@gmail.com / password123 (Role: CUSTOMER)");
}
main()
    .then(async () => {
